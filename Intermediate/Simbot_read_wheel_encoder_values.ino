...
#define Reverse 0
 ...
 #define L_encoder 25 //2 version 1.0
 #define R_encoder 13 //3 version 1.0
  // LED Outputs
 #define led_T 18 //13 version 1.0
 #define led_B 19 //12 version 1.0
...
int a;
//for measuring the distance in inches...
int PPR=8;
float dia = 1.3385827; //0.034m to inches.
float r=dia/2;
float PPI=PPR/(2*3.14*r); //Pulses per inch
float L;
...
a=(counter+counter1)/2;
L=a/PPI;// Length/Distance moved in inches
Serial.print("Length :");
Serial.print(L);
}
...
//dia = 1.3385827 //0.034 to inches.
//r=dia/2;
//PPI=PPR/(2*3.14*r); //Pulses per inch
//L=
